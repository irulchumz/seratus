        ...
        <div class="col-md-6" style="padding-left: 0;">
            ...
            <div class="col-md-2 warnadasar magazine-left" style="height: 724px;">
                <ul style="margin-top: 30px;">
                    <li style="margin: 12px;"><a href="#" style="color: black"><i class="fa fa-2x fa-facebook"></i></a></li>
                    <li style="margin: 12px;"><a href="#" style="color: black"><i class="fa fa-2x fa-instagram"></i></a></li>
                    <li style="margin: 12px;"><a href="#" style="color: black"><i class="fa fa-2x fa-twitter"></i></a></li>
                    <li style="margin: 12px;"><a href="#" style="color: black"><i class="fa fa-2x fa-telegram"></i></a></li>
                </ul>
            </div>
...
<div class="section pt-85">
    <div class="container">
        ...
        <div style="float: left;width: 50%;margin-right: 25%;">
            <p class="text-cabin text-16" style="line-height: 20px;color: black;margin-bottom: 40px;">
                Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat.
                Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat.
                Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat.
                Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat.
            ...
            <p class="text-cabin text-16" style="line-height: 20px;color: black;margin-top: 20px;margin-left: 10%;margin-bottom: 0;">
                Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat.
                Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat.
                Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat.
                Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat. Bermula dari tindakan berolak dari amerika Serikat.
